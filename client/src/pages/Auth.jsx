    ...
    <Fragment>
      <div className="min-h-screen overflow-hidden bg-white text-black px-8">
        ...
        <main className="max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <h1 className="text-5xl lg:text-6xl font-extrabold bg-gradient-to-br from-black/90 via-black/60 to-black/90 leading-tight bg-clip-text text-transparent">
            ...
            <motion.button
              ...
              className="mt-10 px-3 py-3 rounded-xl flex items-center gap-3 bg-gradient-to-br from-black/90 via-black/80 to-black/90 border border-white/10 text-white font-semibold text-lg shadow-[0_25px_60px_rgba(0,0,0,0.7)]"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <Feature
              icon="📊"
              title="Chart and Graphs"
              des="Auto-generate diagrams, charts, and flow graphs."
            />
            <Feature
              icon="📙"
  ...
  return (
    ...
    >
      <div className="relative z-10" style={{ transform: "translateZ(30px)" }}>
        ...
        <p className="text-gray-300 text-sm leading-relative">{des}</p>
      </div>
    </motion.div>
  );
}
